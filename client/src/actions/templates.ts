...
/**
 * GET /templates?tags=popular → getPopularTemplates()
 *
 * Returns up to 4 active templates tagged as 'popular', sorted free-first.
...
> {
  try {
    ...
    console.log("Fetched popular templates:", templates);
    return { data: templates };
  } catch (e) {
    return {
