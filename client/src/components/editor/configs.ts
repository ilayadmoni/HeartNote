...
export const EDITOR_CONFIGS: Record<string, EditorConfig> = {
  ...
  "punching-bag": {
    ...
    fields: [
      ...
      { key: "hitsRequired", label: "מספר מכות נדרשות", type: "number" },
  ...
  "birthday-candles": {
    ...
    fields: [
      { key: "title", label: "כותרת", type: "text", placeholder: "מערכת כיבוי נרות דיגיטלית", maxLength: 60 },
      { key: "subtitle", label: "כותרת משנה", type: "text", placeholder: "הקישי על הלהבות כדי לכבות את הנרות ולבקש משאלה.", maxLength: 120 },
      { key: "candleCount", label: "מספר נרות (1-10)", type: "number" },
    ...
    defaultData: {
      title: "מערכת כיבוי נרות דיגיטלית",
  ...
  "excuse-generator": {
    ...
    fields: [
      ...
      { key: "excuses", label: "תירוצים (3-20)", type: "options" },
      { key: "buttonLabel", label: "טקסט כפתור", type: "text", placeholder: "ג'נרט תירוץ", maxLength: 40 },
      { key: "disclaimer", label: "כתב ויתור", type: "textarea", placeholder: "* החברה אינה אחראית לתוצאות השימוש בתירוצים אלו." },
      { key: "primaryColor", label: "צבע ראשי", type: "color" },
    ],
    defaultData: {
  ...
  "apology-search": {
    ...
    fields: [
      ...
      { key: "resultTitle", label: "כותרת תוצאה", type: "text", placeholder: "סליחה שהייתי עצבנית", maxLength: 80 },
      { key: "resultSubtitle", label: "תיאור תוצאה", type: "textarea", placeholder: "אתה צודק. אוהבת אותך.", maxLength: 200 },
