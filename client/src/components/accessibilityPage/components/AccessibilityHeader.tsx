 ...
 * Header section for the accessibility statement page.
 */
...
export async function AccessibilityHeader(): Promise<JSX.Element> {
  ...
  return (
    <div className="text-center mb-10">
      <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent-soft mb-5">
        <AccessibilityIcon size={32} className="text-accent" />
      </div>
