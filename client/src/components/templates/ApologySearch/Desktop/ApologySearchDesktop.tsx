        ...
        <AnimatePresence mode="wait">
          {phase !== "result" ? (
            ...
            >
              ...
              {/* Search bar */}
              <div className="w-full max-w-lg bg-white border-2 border-[#e8ddd8] rounded-full px-6 py-4 flex items-center shadow-lg gap-3 transition-all focus-within:border-[#c2b5b0]">
                ...
                >
                  ...
                  {(phase === "typing") && (
                    <motion.span
                      ...
                      className="inline-block w-0.5 h-5 bg-[#1b263b] align-middle mr-0.5"
                    />
                  )}
                </span>
              </div>
              ...
              <AnimatePresence>
                {phase === "idle" && (
                  <motion.button
                    ...
                    exit={{ opacity: 0, y: 6 }}
                    onClick={onStart}
                    className="px-8 py-3 rounded-full font-medium text-white text-hebrew-body shadow-md hover:opacity-90 active:scale-95 transition-all"
                    style={{ backgroundColor: primaryColor }}
                  >
