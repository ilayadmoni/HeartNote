...
import { getBirthdayCandlePlan } from "./candle-utils";
...
export function BirthdayCandlesInteractive({
  ...
  // Check if all candles are extinguished and trigger delayed reveal
  useEffect(() => {
    if (lit.every((item) => !item) && !showGreeting) {
      ...
      if (reduceMotion) {
        ...
        // Small delay for celebration moment before showing greeting
    ...
    >
      <div className="relative aspect-square w-full max-w-sm overflow-visible">
        ...
        >
          ...
          {/* Cake wrapper - relative positioned to anchor candles directly to cake */}
          <div className="relative mt-12 w-full max-w-[500px] sm:max-w-[1000px]">
            {/* Candles - absolutely positioned relative to cake wrapper */}
            <div
            ...
            {/* Cake image - base element that anchors positioning */}
            <Image
