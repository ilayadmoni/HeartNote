/**
 * WelcomeSplash Constants
 * Configuration values and Hebrew text for the splash screen
 */

/** Duration the progress bar takes to fill 0→100% (seconds) */
export const PROGRESS_FILL_DURATION = 2;
...
export const PROGRESS_BAR_DELAY = 0.5;
