...
export function SplashLogo({ className = "" }: SplashLogoProps): JSX.Element {
  return (
    <motion.div
    ...
    >
      ...
      {/* Brand Text */}
      <span className="font-display text-display-md text-ink transition-colors duration-300" dir="ltr">
        HeartNote
      </span>
    </motion.div>
  );
